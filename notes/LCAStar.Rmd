...
```{r}
data <- read.table("/Users/nielsh/Dropbox\ (Personal)/projects/LCAStar/lca_star_test1.txt", sep="\t", header=T)
...
```{r}
data2 <- read.table("/Users/nielsh/Dropbox\ (Personal)/projects/LCAStar/lca_star_test2.txt", sep="\t", quote=c("\"", "\'"), header=T)
