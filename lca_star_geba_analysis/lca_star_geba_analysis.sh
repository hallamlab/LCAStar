...
python contig_to_taxa_map.py -i ${lca_star_test}/metapathways_out/lca_star_test1/preprocessed/lca_star_test1.mapping.txt \
	-n ${lca_star_test}/ncbi_bacteria_genomes/ncbi/summary.txt \
		-o ${lca_star_test}/resources/lca_star_test1_contigmap.txt
python contig_to_taxa_map.py -i ${lca_star_test}/metapathways_out/lca_star_test2/preprocessed/lca_star_test2.mapping.txt \
	-n ${lca_star_test}/ncbi_bacteria_genomes/ncbi/summary.txt \
